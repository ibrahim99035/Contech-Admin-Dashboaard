    ...
    <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-100 hover:shadow-sm transition-shadow">
      ...
      <div className="flex items-center space-x-4">
        <div className="text-right">
          <p className="text-sm font-medium text-gray-900">{user.apartment}</p>
  ...
  const ApartmentCard = ({ apartment }) => (
    <div className="bg-white p-6 rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className={`px-2 py-1 text-xs font-medium rounded-full ${
          apartment.status === 'active' ? 'bg-green-100 text-green-800' : 
          apartment.status === 'maintenance' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'
        }`}>
          {apartment.status}
        </span>
      </div>
      <div className="space-y-2 mb-4">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className="font-medium">{apartment.devices}</span>
        </div>
        <div className="flex justify-between text-sm">
          <span className="text-gray-600">Users:</span>
          <span className="font-medium">{apartment.users}</span>
        </div>
        <div className="flex justify-between text-sm">
          <span className="text-gray-600">Creator:</span>
          <span className="font-medium">{apartment.creator}</span>
        </div>
      </div>
      <div className="flex items-center justify-between">
        <span className="text-xs text-gray-500">Created {apartment.created}</span>
    ...
    <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-100 hover:shadow-sm transition-shadow">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">{room.apartment} • {room.type}</p>
        </div>
      </div>
      <div className="flex items-center space-x-4">
        <div className="text-right">
          <p className="text-sm font-medium text-gray-900">{room.devices} devices</p>
          <p className="text-xs text-gray-500">{room.users} users</p>
        </div>
        <div className="flex items-center space-x-2">
          {room.hasPassword && (
            <Shield className="w-4 h-4 text-yellow-600" />
          )}
          <span className="text-xs text-gray-500">by {room.creator}</span>
        </div>
        <button className="p-1 hover:bg-gray-100 rounded">
          <MoreVertical className="w-4 h-4 text-gray-400" />
        </button>
    ...
    <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-100 hover:shadow-sm transition-shadow">
      <div className="flex items-center space-x-3">
        <div className={`p-2 rounded-lg ${device.status === 'online' ? 'bg-green-50' : 'bg-red-50'}`}>
          <Lightbulb className={`w-5 h-5 ${device.status === 'online' ? 'text-green-600' : 'text-red-600'}`} />
        </div>
        <div>
          <p className="font-medium text-gray-900">{device.name}</p>
          <p className="text-sm text-gray-500">{device.type} • {device.room}</p>
        </div>
      </div>
      <div className="flex items-center space-x-2">
    ...
    <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-100 hover:shadow-sm transition-shadow">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">{task.device} • {task.type}</p>
        </div>
      </div>
      <div className="flex items-center space-x-2">
        <div className="text-right">
          <p className="text-sm text-gray-900">{task.scheduledTime}</p>
          <p className="text-xs text-gray-500">by {task.creator}</p>
        </div>
        <span className={`px-2 py-1 text-xs font-medium rounded-full ${
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <StatCard title="Active Users" value="1,089" icon={Activity} color="green" />
              <StatCard title="Admins" value="5" icon={Shield} color="purple" />
              <StatCard title="New This Month" value="47" icon={TrendingUp} color="yellow" />
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">Manage apartment complexes and their configurations</p>
              </div>
              <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center space-x-2">
                <Plus className="w-4 h-4" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <StatCard title="Active" value="85" icon={Activity} color="green" />
              <StatCard title="Maintenance" value="3" icon={Settings} color="yellow" />
              <StatCard title="Avg Devices" value="145" icon={Lightbulb} color="purple" />
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">Manage individual rooms and their device configurations</p>
              </div>
              <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center space-x-2">
                <Plus className="w-4 h-4" />
                <span>Add Room</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <StatCard title="With Devices" value="423" icon={Lightbulb} color="green" />
              <StatCard title="Protected" value="89" icon={Shield} color="yellow" />
              <StatCard title="Avg Devices" value="4.7" icon={Activity} color="purple" />
            </div>
